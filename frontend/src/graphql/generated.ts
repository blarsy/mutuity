...
export type Account = Node & {
  ...
  activationVerifiedAt: Maybe<Scalars['Datetime']['output']>;
  ...
  requirePasswordResetOnNextLogin: Scalars['Boolean']['output'];
...
export type AccountInput = {
  activationVerifiedAt?: InputMaybe<Scalars['Datetime']['input']>;
  ...
  requirePasswordResetOnNextLogin?: InputMaybe<Scalars['Boolean']['input']>;
  updatedAt?: InputMaybe<Scalars['Datetime']['input']>;
};
...
/** All input for the `deleteMyAccount` mutation. */
...
/** The output of our `deleteMyAccount` mutation. */
...
/** A `LatestLandingItemsRecord` edge in the connection. */
export type LatestLandingItemEdge = {
  __typename: 'LatestLandingItemEdge';
  /** A cursor for use in pagination. */
  cursor: Maybe<Scalars['Cursor']['output']>;
  /** The `LatestLandingItemsRecord` at the end of the edge. */
  node: LatestLandingItemsRecord;
};

/** A connection to a list of `LatestLandingItemsRecord` values. */
export type LatestLandingItemsConnection = {
  __typename: 'LatestLandingItemsConnection';
  /** A list of edges which contains the `LatestLandingItemsRecord` and cursor to aid in pagination. */
  edges: Array<LatestLandingItemEdge>;
  /** A list of `LatestLandingItemsRecord` objects. */
  nodes: Array<LatestLandingItemsRecord>;
  /** The count of *all* `LatestLandingItemsRecord` you could get from the connection. */
  totalCount: Scalars['Int']['output'];
};

/** The return type of our `latestLandingItems` query. */
export type LatestLandingItemsRecord = {
  __typename: 'LatestLandingItemsRecord';
  createdAt: Maybe<Scalars['Datetime']['output']>;
...
export type Mutation = {
  ...
  deleteMyAccount: Maybe<DeleteMyAccountPayload>;
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationRegisterLocalAccountWithSocialIdentityArgs = {
...
export type Query = Node & {
  ...
  /** Reads and enables pagination through a set of `SearchNeedResult`. */
  searchNeeds: Maybe<SearchNeedResultsConnection>;
...
/** The root query type which gives access points into the data universe. */
export type QueryLatestLandingAccountsArgs = {
  after?: InputMaybe<Scalars['Cursor']['input']>;
  before?: InputMaybe<Scalars['Cursor']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The root query type which gives access points into the data universe. */
export type QueryLatestLandingItemsArgs = {
  after?: InputMaybe<Scalars['Cursor']['input']>;
  before?: InputMaybe<Scalars['Cursor']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type QuerySearchNeedsArgs = {
  ...
  favorLocalResources?: InputMaybe<Scalars['Boolean']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  latitude?: InputMaybe<Scalars['BigFloat']['input']>;
  limitCount?: InputMaybe<Scalars['Int']['input']>;
  longitude?: InputMaybe<Scalars['BigFloat']['input']>;
  maxDistanceKm?: InputMaybe<Scalars['BigFloat']['input']>;
...
export type RegisterLocalAccountWithSocialIdentityInput = {
  ...
  providerEmailVerified?: InputMaybe<Scalars['Boolean']['input']>;
  providerSubject?: InputMaybe<Scalars['String']['input']>;
  verificationTtlMs?: InputMaybe<Scalars['BigInt']['input']>;
};

/** The output of our `registerLocalAccountWithSocialIdentity` mutation. */
export type RegisterLocalAccountWithSocialIdentityPayload = {
  __typename: 'RegisterLocalAccountWithSocialIdentityPayload';
  boolean: Maybe<Scalars['Boolean']['output']>;
  /**
   * The exact same `clientMutationId` that was provided in the mutation input,
   * unchanged and unused. May be used by a client to track mutations.
...
export type SearchNeedResult = {
  __typename: 'SearchNeedResult';
...
/** A connection to a list of `SearchNeedResult` values. */
export type SearchNeedResultsConnection = {
  __typename: 'SearchNeedResultsConnection';
  /** A list of edges which contains the `SearchNeedResult` and cursor to aid in pagination. */
  edges: Array<SearchNeedResultsEdge>;
  /** A list of `SearchNeedResult` objects. */
  nodes: Array<SearchNeedResult>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** The count of *all* `SearchNeedResult` you could get from the connection. */
  totalCount: Scalars['Int']['output'];
};

/** A `SearchNeedResult` edge in the connection. */
export type SearchNeedResultsEdge = {
  __typename: 'SearchNeedResultsEdge';
  /** A cursor for use in pagination. */
  cursor: Maybe<Scalars['Cursor']['output']>;
  /** The `SearchNeedResult` at the end of the edge. */
  node: SearchNeedResult;
};
...
export type UpdateCampaignForModerationInput = {
  ...
  pImageUrl?: InputMaybe<Scalars['String']['input']>;
...
export type AdminGetCampaignDetailsQueryVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
}>;


export type AdminGetCampaignDetailsQuery = { __typename: 'Query', campaignById: { __typename: 'Campaign', creatorAccountId: any, title: string, theme: string, description: string | null, imageUrl: string | null, managerNoteFromCreator: string | null, rewardsMultiplier: number, airdropAmount: number, startAt: any, airdropAt: any, endAt: any, moderationStatus: CampaignModerationStatus, createdAt: any, updatedAt: any } | null };
...
export type RegisterLocalAccountWithSocialIdentityMutationVariables = Exact<{
  ...
  providerSubject: Scalars['String']['input'];
  providerEmail?: InputMaybe<Scalars['String']['input']>;
  providerEmailVerified?: InputMaybe<Scalars['Boolean']['input']>;
  preferredLanguage?: InputMaybe<Scalars['String']['input']>;
  verificationTtlMs?: InputMaybe<Scalars['BigInt']['input']>;
...
export type UpdateCampaignForModerationMutationVariables = Exact<{
  ...
  pDescription: Scalars['String']['input'];
  pManagerNoteFromCreator?: InputMaybe<Scalars['String']['input']>;
...
export type UpdateCampaignForModerationMutation = { __typename: 'Mutation', updateCampaignForModeration: { __typename: 'UpdateCampaignForModerationPayload', campaign: { __typename: 'Campaign', id: any, title: string, theme: string, description: string | null, imageUrl: string | null, managerNoteFromCreator: string | null, rewardsMultiplier: number, airdropAmount: number, startAt: any, airdropAt: any, endAt: any, moderationStatus: CampaignModerationStatus, createdAt: any } | null } | null };
...
export type CampaignModerationDetailsQuery = { __typename: 'Query', campaignById: { __typename: 'Campaign', id: any, title: string, theme: string, description: string | null, imageUrl: string | null, managerNoteFromCreator: string | null, rewardsMultiplier: number, airdropAmount: number, startAt: any, airdropAt: any, endAt: any, moderationStatus: CampaignModerationStatus, createdAt: any } | null };
...
export type CampaignResourceTriageQueryVariables = Exact<{
  campaignId?: InputMaybe<Scalars['UUID']['input']>;
}>;


export type CampaignResourceTriageQuery = { __typename: 'Query', allCampaignResources: { __typename: 'CampaignResourcesConnection', nodes: Array<{ __typename: 'CampaignResource', campaignId: any, resourceId: any, status: CampaignNeedStatus, createdAt: any, actedAt: any | null, actedByAccountId: any | null, campaignByCampaignId: { __typename: 'Campaign', id: any, title: string } | null, resourceByResourceId: { __typename: 'Resource', id: any, title: string, location: string | null, defaultTokenAmount: number | null } | null }> } | null };

export type AcceptCampaignResourceMutationVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
  resourceId: Scalars['UUID']['input'];
}>;


export type AcceptCampaignResourceMutation = { __typename: 'Mutation', acceptCampaignResource: { __typename: 'AcceptCampaignResourcePayload', campaignResource: { __typename: 'CampaignResource', campaignId: any, resourceId: any, status: CampaignNeedStatus, actedByAccountId: any | null, actedAt: any | null } | null } | null };

export type RejectCampaignResourceMutationVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
  resourceId: Scalars['UUID']['input'];
}>;


export type RejectCampaignResourceMutation = { __typename: 'Mutation', rejectCampaignResource: { __typename: 'RejectCampaignResourcePayload', campaignResource: { __typename: 'CampaignResource', campaignId: any, resourceId: any, status: CampaignNeedStatus, actedByAccountId: any | null, actedAt: any | null } | null } | null };
...
export type CreateCampaignMutation = { __typename: 'Mutation', createCampaign: { __typename: 'CreateCampaignPayload', campaign: { __typename: 'Campaign', id: any, title: string, imageUrl: string | null, moderationStatus: CampaignModerationStatus, startAt: any, airdropAt: any, endAt: any } | null } | null };

export type CreateCampaignLegacyMutationVariables = Exact<{
  title: Scalars['String']['input'];
  theme: Scalars['String']['input'];
  description: Scalars['String']['input'];
  managerNoteFromCreator?: InputMaybe<Scalars['String']['input']>;
...
export type CreateCampaignLegacyMutation = { __typename: 'Mutation', createCampaign: { __typename: 'CreateCampaignPayload', campaign: { __typename: 'Campaign', id: any, title: string, moderationStatus: CampaignModerationStatus, startAt: any, airdropAt: any, endAt: any } | null } | null };
...
export type PublicCampaignDetailQueryVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
}>;


export type PublicCampaignDetailQuery = { __typename: 'Query', campaignById: { __typename: 'Campaign', id: any, creatorAccountId: any, title: string, description: string | null, theme: string, moderationStatus: CampaignModerationStatus, imageUrl: string | null, startAt: any, airdropAt: any, endAt: any, accountByCreatorAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null } | null };
...
export type CountUnreadChatConversationsQueryVariables = Exact<{ [key: string]: never; }>;


export type CountUnreadChatConversationsQuery = { __typename: 'Query', countUnreadChatConversations: number | null };
...
export type ChatResourceConversationQuery = { __typename: 'Query', resourceConversationById: { __typename: 'ResourceConversation', id: any, resourceBidId: any | null, resourceId: any, ownerAccountId: any, bidderAccountId: any, createdAt: any, updatedAt: any, resourceByResourceId: { __typename: 'Resource', id: any, title: string, imageUrls: Array<string | null> } | null, accountByOwnerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string, avatarUrl: string | null } | null, accountByBidderAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string, avatarUrl: string | null } | null, resourceMessagesByConversationId: { __typename: 'ResourceMessagesConnection', nodes: Array<{ __typename: 'ResourceMessage', id: any, conversationId: any, senderAccountId: any, body: string, createdAt: any, readAt: any | null, resourceMessageImagesByMessageId: { __typename: 'ResourceMessageImagesConnection', nodes: Array<{ __typename: 'ResourceMessageImage', id: any, imageUrl: string, sortOrder: number }> } }> } } | null };
...
export type ClaimConversationLookupQueryVariables = Exact<{
  needId: Scalars['UUID']['input'];
  creatorAccountId: Scalars['UUID']['input'];
  claimerAccountId: Scalars['UUID']['input'];
}>;
...
export type ClaimConversationLookupQuery = { __typename: 'Query', claimConversationByNeedIdAndCreatorAccountIdAndClaimerAccountId: { __typename: 'ClaimConversation', id: any } | null };
...
export type ChatClaimConversationQuery = { __typename: 'Query', claimConversationById: { __typename: 'ClaimConversation', id: any, needClaimId: any | null, needId: any, creatorAccountId: any, claimerAccountId: any, createdAt: any, needByNeedId: { __typename: 'Need', id: any, title: string, imageUrls: Array<string | null> | null } | null, accountByCreatorAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string, avatarUrl: string | null } | null, accountByClaimerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string, avatarUrl: string | null } | null, claimMessagesByConversationId: { __typename: 'ClaimMessagesConnection', nodes: Array<{ __typename: 'ClaimMessage', id: any, conversationId: any, senderAccountId: any, body: string, createdAt: any, readAt: any | null, claimMessageImagesByMessageId: { __typename: 'ClaimMessageImagesConnection', nodes: Array<{ __typename: 'ClaimMessageImage', id: any, imageUrl: string, sortOrder: number }> } }> } } | null };
...
export type ViewerSentClaimsQueryVariables = Exact<{
  viewerId: Scalars['UUID']['input'];
}>;


export type ViewerSentClaimsQuery = { __typename: 'Query', currentTokenBalance: number | null, allNeedClaims: { __typename: 'NeedClaimsConnection', nodes: Array<{ __typename: 'NeedClaim', id: any, needId: any, claimerAccountId: any, message: string | null, status: NeedClaimStatus, createdAt: any, updatedAt: any, settledAt: any | null, settledByAccountId: any | null, needByNeedId: { __typename: 'Need', id: any, title: string, creatorAccountId: any, proposedTopesAmount: number | null, imageUrls: Array<string | null> | null } | null, accountByClaimerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, claimConversationsByNeedClaimId: { __typename: 'ClaimConversationsConnection', nodes: Array<{ __typename: 'ClaimConversation', id: any }> }, needClaimSettlementEventByNeedClaimId: { __typename: 'NeedClaimSettlementEvent', id: any, topesAmount: number, createdAt: any, settledByAccountId: any } | null }> } | null };

export type ViewerReceivedClaimsQueryVariables = Exact<{
  viewerId: Scalars['UUID']['input'];
}>;


export type ViewerReceivedClaimsQuery = { __typename: 'Query', allNeedClaims: { __typename: 'NeedClaimsConnection', nodes: Array<{ __typename: 'NeedClaim', id: any, needId: any, claimerAccountId: any, message: string | null, status: NeedClaimStatus, createdAt: any, updatedAt: any, settledAt: any | null, settledByAccountId: any | null, needByNeedId: { __typename: 'Need', id: any, title: string, creatorAccountId: any, proposedTopesAmount: number | null, imageUrls: Array<string | null> | null } | null, accountByClaimerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, claimConversationsByNeedClaimId: { __typename: 'ClaimConversationsConnection', nodes: Array<{ __typename: 'ClaimConversation', id: any }> }, needClaimSettlementEventByNeedClaimId: { __typename: 'NeedClaimSettlementEvent', id: any, topesAmount: number, createdAt: any, settledByAccountId: any } | null }> } | null };

export type ViewerClaimOverviewQueryVariables = Exact<{
  viewerId: Scalars['UUID']['input'];
}>;


export type ViewerClaimOverviewQuery = { __typename: 'Query', currentTokenBalance: number | null, sentNeedClaims: { __typename: 'NeedClaimsConnection', nodes: Array<{ __typename: 'NeedClaim', id: any, needId: any, claimerAccountId: any, message: string | null, status: NeedClaimStatus, createdAt: any, updatedAt: any, settledAt: any | null, settledByAccountId: any | null, needByNeedId: { __typename: 'Need', id: any, title: string, creatorAccountId: any, proposedTopesAmount: number | null, imageUrls: Array<string | null> | null } | null, accountByClaimerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, claimConversationsByNeedClaimId: { __typename: 'ClaimConversationsConnection', nodes: Array<{ __typename: 'ClaimConversation', id: any }> }, needClaimSettlementEventByNeedClaimId: { __typename: 'NeedClaimSettlementEvent', id: any, topesAmount: number, createdAt: any, settledByAccountId: any } | null }> } | null, receivedNeedClaims: { __typename: 'NeedClaimsConnection', nodes: Array<{ __typename: 'NeedClaim', id: any, needId: any, claimerAccountId: any, message: string | null, status: NeedClaimStatus, createdAt: any, updatedAt: any, settledAt: any | null, settledByAccountId: any | null, needByNeedId: { __typename: 'Need', id: any, title: string, creatorAccountId: any, proposedTopesAmount: number | null, imageUrls: Array<string | null> | null } | null, accountByClaimerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, claimConversationsByNeedClaimId: { __typename: 'ClaimConversationsConnection', nodes: Array<{ __typename: 'ClaimConversation', id: any }> }, needClaimSettlementEventByNeedClaimId: { __typename: 'NeedClaimSettlementEvent', id: any, topesAmount: number, createdAt: any, settledByAccountId: any } | null }> } | null, allNeedClaimNotifications: { __typename: 'NeedClaimNotificationsConnection', nodes: Array<{ __typename: 'NeedClaimNotification', id: any, needClaimId: any, eventType: string, payload: any, createdAt: any, readAt: any | null }> } | null };
...
export type NeedClaimManagementQuery = { __typename: 'Query', needClaimById: { __typename: 'NeedClaim', id: any, needId: any, claimerAccountId: any, message: string | null, status: NeedClaimStatus, createdAt: any, updatedAt: any, settledAt: any | null, settledByAccountId: any | null, needByNeedId: { __typename: 'Need', id: any, title: string, creatorAccountId: any, proposedTopesAmount: number | null, imageUrls: Array<string | null> | null } | null, accountByClaimerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, needClaimSettlementEventByNeedClaimId: { __typename: 'NeedClaimSettlementEvent', id: any, needClaimId: any, needId: any, settledByAccountId: any, claimerAccountId: any, topesAmount: number, createdAt: any } | null } | null };
...
export type NeedEditDetailQuery = { __typename: 'Query', needById: { __typename: 'Need', id: any, title: string, description: string | null, location: string, latitude: any, longitude: any, intensity: NeedIntensity, proposedTopesAmount: number | null, objectRequired: boolean, competenceRequired: boolean, toolingRequired: boolean, multiplePeopleRequired: boolean, requiredCompetenceText: string | null, requiredToolingText: string | null, requiredPeopleCount: number | null, imageUrls: Array<string | null> | null, expiresAt: any | null, campaignNeedsByNeedId: { __typename: 'CampaignNeedsConnection', nodes: Array<{ __typename: 'CampaignNeed', campaignId: any }> } } | null };

export type PublicNeedDetailQueryVariables = Exact<{
  needId: Scalars['UUID']['input'];
}>;


export type PublicNeedDetailQuery = { __typename: 'Query', needById: { __typename: 'Need', id: any, creatorAccountId: any, title: string, description: string | null, location: string, intensity: NeedIntensity, proposedTopesAmount: number | null, imageUrls: Array<string | null> | null, expiresAt: any | null, isActive: boolean, accountByCreatorAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null } | null };
...
export type PublicNeedCampaignFilterQueryVariables = Exact<{ [key: string]: never; }>;


export type PublicNeedCampaignFilterQuery = { __typename: 'Query', allCampaigns: { __typename: 'CampaignsConnection', nodes: Array<{ __typename: 'Campaign', id: any, title: string, startAt: any, endAt: any }> } | null, publicCampaignNeedLinks: { __typename: 'PublicCampaignNeedLinksConnection', nodes: Array<{ __typename: 'PublicCampaignNeedLinksRecord', campaignId: any | null, needId: any | null }> } | null };

export type CreateCampaignNeedLinkMutationVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
  needId: Scalars['UUID']['input'];
}>;


export type CreateCampaignNeedLinkMutation = { __typename: 'Mutation', createCampaignNeed: { __typename: 'CreateCampaignNeedPayload', campaignNeed: { __typename: 'CampaignNeed', campaignId: any, needId: any } | null } | null };

export type DeleteCampaignNeedLinkMutationVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
  needId: Scalars['UUID']['input'];
}>;


export type DeleteCampaignNeedLinkMutation = { __typename: 'Mutation', deleteCampaignNeedByCampaignIdAndNeedId: { __typename: 'DeleteCampaignNeedPayload', deletedCampaignNeedId: string | null } | null };
...
export type PublicNeedsQuery = { __typename: 'Query', searchNeeds: { __typename: 'SearchNeedResultsConnection', nodes: Array<{ __typename: 'SearchNeedResult', id: any | null, creatorAccountId: any | null, creatorDisplayName: string | null, title: string | null, description: string | null, location: string | null, latitude: any | null, longitude: any | null, intensity: NeedIntensity | null, proposedTopesAmount: number | null, objectRequired: boolean | null, competenceRequired: boolean | null, toolingRequired: boolean | null, multiplePeopleRequired: boolean | null, requiredCompetenceText: string | null, requiredToolingText: string | null, requiredPeopleCount: number | null, imageUrls: Array<string | null> | null, expiresAt: any | null, createdAt: any | null, closenessScore: any | null, easeOfSetupScore: any | null, expirationScore: any | null, weightedScore: any | null, queryLatitude: any | null, queryLongitude: any | null }> } | null };
...
export type PublicResourceCampaignFilterQueryVariables = Exact<{ [key: string]: never; }>;


export type PublicResourceCampaignFilterQuery = { __typename: 'Query', allCampaigns: { __typename: 'CampaignsConnection', nodes: Array<{ __typename: 'Campaign', id: any, title: string, startAt: any, endAt: any }> } | null, publicCampaignResourceLinks: { __typename: 'PublicCampaignResourceLinksConnection', nodes: Array<{ __typename: 'PublicCampaignResourceLinksRecord', campaignId: any | null, resourceId: any | null }> } | null };
...
export type ResourceDetailQuery = { __typename: 'Query', resourceById: { __typename: 'Resource', id: any, creatorAccountId: any, title: string, description: string | null, location: string | null, latitude: any | null, longitude: any | null, intensity: NeedIntensity, defaultTokenAmount: number | null, imageUrls: Array<string | null>, categoryLabels: Array<string | null> | null, isProduct: boolean, isService: boolean, canBeGiven: boolean, canBeExchanged: boolean, canBeTakenAway: boolean, canBeDelivered: boolean, expiresAt: any | null, isActive: boolean, createdAt: any, updatedAt: any, accountByCreatorAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string, avatarUrl: string | null } | null } | null };

export type ResourceEditDetailQueryVariables = Exact<{
  resourceId: Scalars['UUID']['input'];
}>;


export type ResourceEditDetailQuery = { __typename: 'Query', resourceById: { __typename: 'Resource', id: any, title: string, description: string | null, location: string | null, latitude: any | null, longitude: any | null, intensity: NeedIntensity, defaultTokenAmount: number | null, imageUrls: Array<string | null>, categoryLabels: Array<string | null> | null, isProduct: boolean, isService: boolean, canBeGiven: boolean, canBeExchanged: boolean, canBeTakenAway: boolean, canBeDelivered: boolean, expiresAt: any | null, isActive: boolean, createdAt: any, updatedAt: any, resourceCategoryAssignmentsByResourceId: { __typename: 'ResourceCategoryAssignmentsConnection', nodes: Array<{ __typename: 'ResourceCategoryAssignment', categoryCode: number }> }, campaignResourcesByResourceId: { __typename: 'CampaignResourcesConnection', nodes: Array<{ __typename: 'CampaignResource', campaignId: any }> } } | null };

export type LinkableResourceCampaignOptionsQueryVariables = Exact<{ [key: string]: never; }>;


export type LinkableResourceCampaignOptionsQuery = { __typename: 'Query', allCampaigns: { __typename: 'CampaignsConnection', nodes: Array<{ __typename: 'Campaign', id: any, title: string, startAt: any, endAt: any }> } | null };

export type CreateCampaignResourceLinkMutationVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
  resourceId: Scalars['UUID']['input'];
}>;


export type CreateCampaignResourceLinkMutation = { __typename: 'Mutation', createCampaignResource: { __typename: 'CreateCampaignResourcePayload', campaignResource: { __typename: 'CampaignResource', campaignId: any, resourceId: any } | null } | null };

export type DeleteCampaignResourceLinkMutationVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
  resourceId: Scalars['UUID']['input'];
}>;


export type DeleteCampaignResourceLinkMutation = { __typename: 'Mutation', deleteCampaignResourceByCampaignIdAndResourceId: { __typename: 'DeleteCampaignResourcePayload', deletedCampaignResourceId: string | null } | null };

export type ResourceBidsForResourceQueryVariables = Exact<{
  resourceId: Scalars['UUID']['input'];
}>;


export type ResourceBidsForResourceQuery = { __typename: 'Query', resourceBidsByResourceId: { __typename: 'ResourceBidsConnection', nodes: Array<{ __typename: 'ResourceBid', id: any, resourceId: any, bidderAccountId: any, message: string | null, proposedTokenAmount: number | null, status: ResourceBidStatus, createdAt: any, respondedAt: any | null, respondedByAccountId: any | null, accountByBidderAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null }> } | null };
...
export type MyResourcesConnectionQuery = { __typename: 'Query', allResources: { __typename: 'ResourcesConnection', nodes: Array<{ __typename: 'Resource', id: any, creatorAccountId: any, title: string, description: string | null, location: string | null, defaultTokenAmount: number | null, imageUrls: Array<string | null>, categoryLabels: Array<string | null> | null, isProduct: boolean, isService: boolean, canBeGiven: boolean, canBeExchanged: boolean, canBeTakenAway: boolean, canBeDelivered: boolean, expiresAt: any | null, createdAt: any, updatedAt: any, accountByCreatorAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: any | null } } | null };
...
export type MyActiveResourcesForCampaignQueryVariables = Exact<{
  creatorAccountId: Scalars['UUID']['input'];
  campaignId: Scalars['UUID']['input'];
}>;


export type MyActiveResourcesForCampaignQuery = { __typename: 'Query', allResources: { __typename: 'ResourcesConnection', nodes: Array<{ __typename: 'Resource', id: any, creatorAccountId: any, title: string, description: string | null, location: string | null, defaultTokenAmount: number | null, imageUrls: Array<string | null>, categoryLabels: Array<string | null> | null, isProduct: boolean, isService: boolean, canBeGiven: boolean, canBeExchanged: boolean, canBeTakenAway: boolean, canBeDelivered: boolean, expiresAt: any | null, updatedAt: any, accountByCreatorAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, campaignResourcesByResourceId: { __typename: 'CampaignResourcesConnection', nodes: Array<{ __typename: 'CampaignResource', status: CampaignNeedStatus }> } }> } | null };

export type RequestResourceJoinToCampaignMutationVariables = Exact<{
  campaignId: Scalars['UUID']['input'];
  resourceId: Scalars['UUID']['input'];
}>;
...
export type ReopenResourceJoinToCampaignMutation = { __typename: 'Mutation', updateCampaignResourceByCampaignIdAndResourceId: { __typename: 'UpdateCampaignResourcePayload', campaignResource: { __typename: 'CampaignResource', campaignId: any, resourceId: any, status: CampaignNeedStatus } | null } | null };

export type LandingTopelaAccountsQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
}>;


export type LandingTopelaAccountsQuery = { __typename: 'Query', latestLandingAccounts: { __typename: 'AccountsConnection', nodes: Array<{ __typename: 'Account', id: any, displayName: string | null, externalSubject: string, avatarUrl: string | null }> } | null };

export type LandingTopelaItemsQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
}>;


export type LandingTopelaItemsQuery = { __typename: 'Query', latestLandingItems: { __typename: 'LatestLandingItemsConnection', nodes: Array<{ __typename: 'LatestLandingItemsRecord', id: any | null, kind: string | null, title: string | null, imageUrl: string | null, creatorDisplayName: string | null, createdAt: any | null }> } | null };
...
export const AdminGetCampaignDetailsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdminGetCampaignDetails"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"creatorAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"theme"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"managerNoteFromCreator"}},{"kind":"Field","name":{"kind":"Name","value":"rewardsMultiplier"}},{"kind":"Field","name":{"kind":"Name","value":"airdropAmount"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"airdropAt"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}},{"kind":"Field","name":{"kind":"Name","value":"moderationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<AdminGetCampaignDetailsQuery, AdminGetCampaignDetailsQueryVariables>;
...
export const UpdateCampaignForModerationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCampaignForModeration"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pCampaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pTitle"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pTheme"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pDescription"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pManagerNoteFromCreator"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pRewardsMultiplier"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pAirdropAmount"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pStartAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pAirdropAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pEndAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pImageUrl"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCampaignForModeration"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"pCampaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pCampaignId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pTitle"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pTitle"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pTheme"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pTheme"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pDescription"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pDescription"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pManagerNoteFromCreator"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pManagerNoteFromCreator"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pRewardsMultiplier"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pRewardsMultiplier"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pAirdropAmount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pAirdropAmount"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pStartAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pStartAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pAirdropAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pAirdropAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pEndAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pEndAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"pImageUrl"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pImageUrl"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"theme"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"managerNoteFromCreator"}},{"kind":"Field","name":{"kind":"Name","value":"rewardsMultiplier"}},{"kind":"Field","name":{"kind":"Name","value":"airdropAmount"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"airdropAt"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}},{"kind":"Field","name":{"kind":"Name","value":"moderationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateCampaignForModerationMutation, UpdateCampaignForModerationMutationVariables>;
...
export const CampaignResourceTriageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CampaignResourceTriage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"allCampaignResources"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"campaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"ListValue","values":[{"kind":"EnumValue","value":"PRIMARY_KEY_DESC"}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignId"}},{"kind":"Field","name":{"kind":"Name","value":"resourceId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"actedAt"}},{"kind":"Field","name":{"kind":"Name","value":"actedByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"campaignByCampaignId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"resourceByResourceId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"defaultTokenAmount"}}]}}]}}]}}]}}]} as unknown as DocumentNode<CampaignResourceTriageQuery, CampaignResourceTriageQueryVariables>;
export const AcceptCampaignResourceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AcceptCampaignResource"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"acceptCampaignResource"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"campaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"resourceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignResource"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignId"}},{"kind":"Field","name":{"kind":"Name","value":"resourceId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"actedByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"actedAt"}}]}}]}}]}}]} as unknown as DocumentNode<AcceptCampaignResourceMutation, AcceptCampaignResourceMutationVariables>;
export const RejectCampaignResourceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RejectCampaignResource"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rejectCampaignResource"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"campaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"resourceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignResource"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignId"}},{"kind":"Field","name":{"kind":"Name","value":"resourceId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"actedByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"actedAt"}}]}}]}}]}}]} as unknown as DocumentNode<RejectCampaignResourceMutation, RejectCampaignResourceMutationVariables>;
export const CreateCampaignDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCampaign"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"title"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"theme"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"description"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"managerNoteFromCreator"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"rewardsMultiplier"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"airdropAmount"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"startAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"airdropAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"endAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"imageUrl"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCampaign"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"title"},"value":{"kind":"Variable","name":{"kind":"Name","value":"title"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"theme"},"value":{"kind":"Variable","name":{"kind":"Name","value":"theme"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"description"},"value":{"kind":"Variable","name":{"kind":"Name","value":"description"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"managerNoteFromCreator"},"value":{"kind":"Variable","name":{"kind":"Name","value":"managerNoteFromCreator"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"rewardsMultiplier"},"value":{"kind":"Variable","name":{"kind":"Name","value":"rewardsMultiplier"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"airdropAmount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"airdropAmount"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"startAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"startAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"airdropAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"airdropAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"endAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"endAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"imageUrl"},"value":{"kind":"Variable","name":{"kind":"Name","value":"imageUrl"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"moderationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"airdropAt"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}}]}}]}}]}}]} as unknown as DocumentNode<CreateCampaignMutation, CreateCampaignMutationVariables>;
export const CreateCampaignLegacyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCampaignLegacy"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"title"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"theme"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"description"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"managerNoteFromCreator"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"rewardsMultiplier"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"airdropAmount"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"startAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"airdropAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"endAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCampaign"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"title"},"value":{"kind":"Variable","name":{"kind":"Name","value":"title"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"theme"},"value":{"kind":"Variable","name":{"kind":"Name","value":"theme"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"description"},"value":{"kind":"Variable","name":{"kind":"Name","value":"description"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"managerNoteFromCreator"},"value":{"kind":"Variable","name":{"kind":"Name","value":"managerNoteFromCreator"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"rewardsMultiplier"},"value":{"kind":"Variable","name":{"kind":"Name","value":"rewardsMultiplier"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"airdropAmount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"airdropAmount"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"startAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"startAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"airdropAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"airdropAt"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"endAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"endAt"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"moderationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"airdropAt"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}}]}}]}}]}}]} as unknown as DocumentNode<CreateCampaignLegacyMutation, CreateCampaignLegacyMutationVariables>;
export const MyCampaignsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MyCampaigns"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"creatorAccountId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"allCampaigns"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"creatorAccountId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"creatorAccountId"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"EnumValue","value":"CREATED_AT_DESC"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"moderationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}}]}}]}}]}}]} as unknown as DocumentNode<MyCampaignsQuery, MyCampaignsQueryVariables>;
...
export const PublicCampaignDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PublicCampaignDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"creatorAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"theme"}},{"kind":"Field","name":{"kind":"Name","value":"moderationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"airdropAt"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}},{"kind":"Field","name":{"kind":"Name","value":"accountByCreatorAccountId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}}]}}]}}]}}]} as unknown as DocumentNode<PublicCampaignDetailQuery, PublicCampaignDetailQueryVariables>;
...
export const CountUnreadChatConversationsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CountUnreadChatConversations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"countUnreadChatConversations"}}]}}]} as unknown as DocumentNode<CountUnreadChatConversationsQuery, CountUnreadChatConversationsQueryVariables>;
...
export const ContributionOverviewDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ContributionOverview"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"viewerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"defaultValue":{"kind":"IntValue","value":"10"}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Cursor"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"currentTokenBalance"}},{"kind":"Field","name":{"kind":"Name","value":"allTokenMovements"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}},{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"accountId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"viewerId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"edges"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cursor"}},{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"eventType"}},{"kind":"Field","name":{"kind":"Name","value":"amountDelta"}},{"kind":"Field","name":{"kind":"Name","value":"referenceType"}},{"kind":"Field","name":{"kind":"Name","value":"referenceId"}},{"kind":"Field","name":{"kind":"Name","value":"payload"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"endCursor"}},{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalCount"}}]}}]}}]} as unknown as DocumentNode<ContributionOverviewQuery, ContributionOverviewQueryVariables>;
...
export const ViewerSentClaimsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ViewerSentClaims"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"viewerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"currentTokenBalance"}},{"kind":"Field","name":{"kind":"Name","value":"allNeedClaims"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"100"}},{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"claimerAccountId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"viewerId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"needId"}},{"kind":"Field","name":{"kind":"Name","value":"claimerAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"needByNeedId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"creatorAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTopesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrls"}}]}},{"kind":"Field","name":{"kind":"Name","value":"accountByClaimerAccountId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}}]}},{"kind":"Field","name":{"kind":"Name","value":"claimConversationsByNeedClaimId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"needClaimSettlementEventByNeedClaimId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"topesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ViewerSentClaimsQuery, ViewerSentClaimsQueryVariables>;
export const ViewerReceivedClaimsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ViewerReceivedClaims"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"viewerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"allNeedClaims"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"100"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"needId"}},{"kind":"Field","name":{"kind":"Name","value":"claimerAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"needByNeedId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"creatorAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTopesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrls"}}]}},{"kind":"Field","name":{"kind":"Name","value":"accountByClaimerAccountId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}}]}},{"kind":"Field","name":{"kind":"Name","value":"claimConversationsByNeedClaimId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"needClaimSettlementEventByNeedClaimId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"topesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ViewerReceivedClaimsQuery, ViewerReceivedClaimsQueryVariables>;
export const ViewerClaimOverviewDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ViewerClaimOverview"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"viewerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"currentTokenBalance"}},{"kind":"Field","alias":{"kind":"Name","value":"sentNeedClaims"},"name":{"kind":"Name","value":"allNeedClaims"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"100"}},{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"claimerAccountId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"viewerId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"needId"}},{"kind":"Field","name":{"kind":"Name","value":"claimerAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"needByNeedId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"creatorAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTopesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrls"}}]}},{"kind":"Field","name":{"kind":"Name","value":"accountByClaimerAccountId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}}]}},{"kind":"Field","name":{"kind":"Name","value":"claimConversationsByNeedClaimId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"needClaimSettlementEventByNeedClaimId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"topesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}}]}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"receivedNeedClaims"},"name":{"kind":"Name","value":"allNeedClaims"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"100"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"needId"}},{"kind":"Field","name":{"kind":"Name","value":"claimerAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"needByNeedId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"creatorAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTopesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrls"}}]}},{"kind":"Field","name":{"kind":"Name","value":"accountByClaimerAccountId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}}]}},{"kind":"Field","name":{"kind":"Name","value":"claimConversationsByNeedClaimId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"needClaimSettlementEventByNeedClaimId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"topesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"settledByAccountId"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"allNeedClaimNotifications"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"100"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"needClaimId"}},{"kind":"Field","name":{"kind":"Name","value":"eventType"}},{"kind":"Field","name":{"kind":"Name","value":"payload"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"readAt"}}]}}]}}]}}]} as unknown as DocumentNode<ViewerClaimOverviewQuery, ViewerClaimOverviewQueryVariables>;
...
export const CreateNeedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateNeed"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"title"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"description"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"location"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"latitude"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BigFloat"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"longitude"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BigFloat"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"intensity"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"NeedIntensity"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"proposedTopesAmount"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"objectRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"competenceRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"toolingRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"multiplePeopleRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"requiredCompetenceText"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"requiredToolingText"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"requiredPeopleCount"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"imageUrls"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"expiresAt"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createNeed"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"title"},"value":{"kind":"Variable","name":{"kind":"Name","value":"title"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"description"},"value":{"kind":"Variable","name":{"kind":"Name","value":"description"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"location"},"value":{"kind":"Variable","name":{"kind":"Name","value":"location"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"latitude"},"value":{"kind":"Variable","name":{"kind":"Name","value":"latitude"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"longitude"},"value":{"kind":"Variable","name":{"kind":"Name","value":"longitude"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"intensity"},"value":{"kind":"Variable","name":{"kind":"Name","value":"intensity"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"proposedTopesAmount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"proposedTopesAmount"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"objectRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"objectRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"competenceRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"competenceRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"toolingRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"toolingRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"multiplePeopleRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"multiplePeopleRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"requiredCompetenceText"},"value":{"kind":"Variable","name":{"kind":"Name","value":"requiredCompetenceText"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"requiredToolingText"},"value":{"kind":"Variable","name":{"kind":"Name","value":"requiredToolingText"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"requiredPeopleCount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"requiredPeopleCount"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"campaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"imageUrls"},"value":{"kind":"Variable","name":{"kind":"Name","value":"imageUrls"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"expiresAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"expiresAt"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"need"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"intensity"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTopesAmount"}}]}}]}}]}}]} as unknown as DocumentNode<CreateNeedMutation, CreateNeedMutationVariables>;
export const UpdateNeedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateNeed"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"title"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"description"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"location"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"latitude"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BigFloat"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"longitude"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BigFloat"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"intensity"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"NeedIntensity"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"proposedTopesAmount"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"objectRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"competenceRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"toolingRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"multiplePeopleRequired"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"requiredCompetenceText"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"requiredToolingText"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"requiredPeopleCount"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"imageUrls"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"expiresAt"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Datetime"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateNeedById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"needPatch"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"title"},"value":{"kind":"Variable","name":{"kind":"Name","value":"title"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"description"},"value":{"kind":"Variable","name":{"kind":"Name","value":"description"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"location"},"value":{"kind":"Variable","name":{"kind":"Name","value":"location"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"latitude"},"value":{"kind":"Variable","name":{"kind":"Name","value":"latitude"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"longitude"},"value":{"kind":"Variable","name":{"kind":"Name","value":"longitude"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"intensity"},"value":{"kind":"Variable","name":{"kind":"Name","value":"intensity"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"proposedTopesAmount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"proposedTopesAmount"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"objectRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"objectRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"competenceRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"competenceRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"toolingRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"toolingRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"multiplePeopleRequired"},"value":{"kind":"Variable","name":{"kind":"Name","value":"multiplePeopleRequired"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"requiredCompetenceText"},"value":{"kind":"Variable","name":{"kind":"Name","value":"requiredCompetenceText"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"requiredToolingText"},"value":{"kind":"Variable","name":{"kind":"Name","value":"requiredToolingText"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"requiredPeopleCount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"requiredPeopleCount"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"imageUrls"},"value":{"kind":"Variable","name":{"kind":"Name","value":"imageUrls"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"expiresAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"expiresAt"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"need"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"intensity"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTopesAmount"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateNeedMutation, UpdateNeedMutationVariables>;
...
export const PublicNeedDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PublicNeedDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"needId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"needById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"needId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"creatorAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"intensity"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTopesAmount"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrls"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"isActive"}},{"kind":"Field","name":{"kind":"Name","value":"accountByCreatorAccountId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}}]}}]}}]}}]} as unknown as DocumentNode<PublicNeedDetailQuery, PublicNeedDetailQueryVariables>;
...
export const ResourceEditDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ResourceEditDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resourceById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"latitude"}},{"kind":"Field","name":{"kind":"Name","value":"longitude"}},{"kind":"Field","name":{"kind":"Name","value":"intensity"}},{"kind":"Field","name":{"kind":"Name","value":"defaultTokenAmount"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrls"}},{"kind":"Field","name":{"kind":"Name","value":"categoryLabels"}},{"kind":"Field","name":{"kind":"Name","value":"isProduct"}},{"kind":"Field","name":{"kind":"Name","value":"isService"}},{"kind":"Field","name":{"kind":"Name","value":"canBeGiven"}},{"kind":"Field","name":{"kind":"Name","value":"canBeExchanged"}},{"kind":"Field","name":{"kind":"Name","value":"canBeTakenAway"}},{"kind":"Field","name":{"kind":"Name","value":"canBeDelivered"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"isActive"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resourceCategoryAssignmentsByResourceId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"EnumValue","value":"CATEGORY_CODE_ASC"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"categoryCode"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"campaignResourcesByResourceId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}},{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"EnumValue","value":"PRIMARY_KEY_DESC"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignId"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ResourceEditDetailQuery, ResourceEditDetailQueryVariables>;
export const LinkableResourceCampaignOptionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LinkableResourceCampaignOptions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"allCampaigns"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"moderationStatus"},"value":{"kind":"EnumValue","value":"APPROVED"}}]}},{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"EnumValue","value":"START_AT_ASC"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}}]}}]}}]}}]} as unknown as DocumentNode<LinkableResourceCampaignOptionsQuery, LinkableResourceCampaignOptionsQueryVariables>;
export const CreateCampaignResourceLinkDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCampaignResourceLink"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCampaignResource"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"campaignResource"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"campaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"resourceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignResource"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignId"}},{"kind":"Field","name":{"kind":"Name","value":"resourceId"}}]}}]}}]}}]} as unknown as DocumentNode<CreateCampaignResourceLinkMutation, CreateCampaignResourceLinkMutationVariables>;
export const DeleteCampaignResourceLinkDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteCampaignResourceLink"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteCampaignResourceByCampaignIdAndResourceId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"campaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"resourceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deletedCampaignResourceId"}}]}}]}}]} as unknown as DocumentNode<DeleteCampaignResourceLinkMutation, DeleteCampaignResourceLinkMutationVariables>;
export const ResourceBidsForResourceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ResourceBidsForResource"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"resourceBidsByResourceId"},"name":{"kind":"Name","value":"allResourceBids"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"resourceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resourceId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"resourceId"}},{"kind":"Field","name":{"kind":"Name","value":"bidderAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"proposedTokenAmount"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"respondedAt"}},{"kind":"Field","name":{"kind":"Name","value":"respondedByAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"accountByBidderAccountId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ResourceBidsForResourceQuery, ResourceBidsForResourceQueryVariables>;
...
export const LandingTopelaAccountsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LandingTopelaAccounts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"defaultValue":{"kind":"IntValue","value":"50"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"latestLandingAccounts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limitCount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"externalSubject"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}}]}}]}}]} as unknown as DocumentNode<LandingTopelaAccountsQuery, LandingTopelaAccountsQueryVariables>;
export const LandingTopelaItemsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LandingTopelaItems"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"defaultValue":{"kind":"IntValue","value":"10"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"latestLandingItems"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limitCount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"creatorDisplayName"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}}]}}]} as unknown as DocumentNode<LandingTopelaItemsQuery, LandingTopelaItemsQueryVariables>;
