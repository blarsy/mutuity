...
export type AuthSessionQuery = { __typename: 'Query', authSession: { __typename: 'AuthSessionPayload', authenticated: boolean, role: string, expiresAt: string | null, account: { __typename: 'AuthSessionAccount', id: string, displayName: string | null, externalSubject: string, avatarUrl: string | null, emailVerified: boolean } | null } };
