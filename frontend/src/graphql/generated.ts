...
export type TokenBalanceChangedSubscriptionVariables = Exact<{
  topic: Scalars['String']['input'];
}>;


export type TokenBalanceChangedSubscription = { __typename: 'Subscription', listen: { __typename: 'ListenPayload', relatedNodeId: string | null } };
...
export type ViewerClaimOverviewQuery = { __typename: 'Query', allNeedClaims: { __typename: 'NeedClaimsConnection', nodes: Array<{ __typename: 'NeedClaim', id: any, needId: any, claimerAccountId: any, message: string | null, status: NeedClaimStatus, createdAt: any, updatedAt: any, settledAt: any | null, settledByAccountId: any | null, needByNeedId: { __typename: 'Need', id: any, title: string, creatorAccountId: any, proposedTopesAmount: number | null } | null, accountByClaimerAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, needClaimSettlementEventByNeedClaimId: { __typename: 'NeedClaimSettlementEvent', id: any, topesAmount: number, createdAt: any, settledByAccountId: any } | null }> } | null, allNeedClaimNotifications: { __typename: 'NeedClaimNotificationsConnection', nodes: Array<{ __typename: 'NeedClaimNotification', id: any, needClaimId: any, eventType: string, payload: any, createdAt: any, readAt: any | null }> } | null };
...
export type BidWorkspaceFieldsFragment = { __typename: 'ResourceBid', id: any, resourceId: any, bidderAccountId: any, message: string | null, proposedTokenAmount: number | null, status: ResourceBidStatus, isActive: boolean | null, validUntil: any, createdAt: any, updatedAt: any, respondedAt: any | null, respondedByAccountId: any | null, accountByBidderAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null, resourceByResourceId: { __typename: 'Resource', id: any, creatorAccountId: any, title: string, description: string | null, location: string, defaultTokenAmount: number | null, imageUrls: Array<string | null>, categoryLabels: Array<string | null> | null, isProduct: boolean, isService: boolean, canBeExchanged: boolean, isActive: boolean, expiresAt: any | null, accountByCreatorAccountId: { __typename: 'Account', id: any, displayName: string | null, externalSubject: string } | null } | null };
...
export const TokenBalanceChangedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"TokenBalanceChanged"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"topic"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"listen"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"topic"},"value":{"kind":"Variable","name":{"kind":"Name","value":"topic"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"relatedNodeId"}}]}}]}}]} as unknown as DocumentNode<TokenBalanceChangedSubscription, TokenBalanceChangedSubscriptionVariables>;
