...
export type SearchResourcesQuery = { __typename: 'Query', searchResources: { __typename: 'SearchResourcesConnection', nodes: Array<{ __typename: 'SearchResourcesRecord', id: unknown, title: string | null, description: string | null, createdAt: unknown, creatorAccountId: unknown, creatorDisplayName: string | null, distanceKm: unknown, latitude: unknown, longitude: unknown, isProduct: boolean | null, isService: boolean | null, canBeTakenAway: boolean | null, canBeDelivered: boolean | null, canBeExchanged: boolean | null, canBeGiven: boolean | null, defaultTokenAmount: number | null, categoryLabels: Array<string | null> | null, imageUrls: Array<string | null> | null }> } | null };
...
export type SearchNeedsQuery = { __typename: 'Query', allNeeds: { __typename: 'NeedsConnection', nodes: Array<{ __typename: 'Need', id: unknown, title: string, description: string | null, proposedTopesAmount: number | null, intensity: NeedIntensity }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: unknown } } | null };
...
export type MyNeedsQuery = { __typename: 'Query', allNeeds: { __typename: 'NeedsConnection', nodes: Array<{ __typename: 'Need', id: unknown, title: string, proposedTopesAmount: number | null, intensity: NeedIntensity }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: unknown } } | null };
...
export type MyCampaignsQuery = { __typename: 'Query', allCampaigns: { __typename: 'CampaignsConnection', nodes: Array<{ __typename: 'Campaign', id: unknown, title: string, moderationStatus: CampaignModerationStatus, startAt: unknown, endAt: unknown }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: unknown } } | null };
...
export type UpdateNeedByIdMutation = { __typename: 'Mutation', updateNeedById: { __typename: 'UpdateNeedPayload', need: { __typename: 'Need', id: unknown, title: string, description: string | null, proposedTopesAmount: number | null } | null } | null };
...
export type AccountProfileQuery = { __typename: 'Query', accountById: { __typename: 'Account', id: unknown, displayName: string | null, bio: string | null, location: string | null, preferredLanguage: string } | null };
...
export type UpdateAccountProfileMutation = { __typename: 'Mutation', updateAccountById: { __typename: 'UpdateAccountPayload', account: { __typename: 'Account', id: unknown, displayName: string | null, bio: string | null, location: string | null } | null } | null };
