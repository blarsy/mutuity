...
export type RespondToResourceBidInput = {
  ...
  clientMutationId?: string | null | undefined;
  resourceBidId?: unknown;
  status?: ResourceBidStatus | null | undefined;
};
...
export type SendResourceMessageDirectInput = {
   ...
   */
  clientMutationId?: string | null | undefined;
  pBody?: string | null | undefined;
  pImageUrls?: Array<string | null | undefined> | null | undefined;
  pOtherAccountId?: unknown;
  pResourceId?: unknown;
};
...
export type SubmitResourceBidInput = {
  ...
  clientMutationId?: string | null | undefined;
  message?: string | null | undefined;
  proposedTokenAmount?: number | null | undefined;
  resourceId?: unknown;
  validHours?: number | null | undefined;
};
...
export type LinkableCampaignsQuery = { __typename: 'Query', linkableCampaigns: { __typename: 'CampaignsConnection', nodes: Array<{ __typename: 'Campaign', id: unknown, title: string, startAt: unknown, endAt: unknown }> } | null };
...
export type ResourceByIdQuery = { __typename: 'Query', resourceById: { __typename: 'Resource', id: unknown, title: string, description: string | null, creatorAccountId: unknown, createdAt: unknown, expiresAt: unknown, isActive: boolean, isProduct: boolean, isService: boolean, canBeTakenAway: boolean, canBeDelivered: boolean, canBeExchanged: boolean, canBeGiven: boolean, location: string | null, latitude: unknown, longitude: unknown, defaultTokenAmount: number | null, categoryLabels: Array<string | null> | null, imageUrls: Array<string | null>, accountByCreatorAccountId: { __typename: 'Account', id: unknown, displayName: string | null, externalSubject: string, avatarUrl: string | null } | null } | null };
...
export type SentResourceBidsQuery = { __typename: 'Query', sentResourceBids: { __typename: 'ResourceBidsConnection', nodes: Array<{ __typename: 'ResourceBid', id: unknown, resourceId: unknown, bidderAccountId: unknown, message: string | null, proposedTokenAmount: number | null, isActive: boolean | null, status: ResourceBidStatus, createdAt: unknown, respondedAt: unknown, validUntil: unknown, updatedAt: unknown, resourceConversationsByResourceBidId: { __typename: 'ResourceConversationsConnection', nodes: Array<{ __typename: 'ResourceConversation', id: unknown }> }, resourceByResourceId: { __typename: 'Resource', id: unknown, title: string, imageUrls: Array<string | null>, defaultTokenAmount: number | null, canBeExchanged: boolean, creatorAccountId: unknown, accountByCreatorAccountId: { __typename: 'Account', id: unknown, displayName: string | null, avatarUrl: string | null } | null } | null, accountByBidderAccountId: { __typename: 'Account', id: unknown, displayName: string | null, avatarUrl: string | null } | null, accountByRespondedByAccountId: { __typename: 'Account', id: unknown, displayName: string | null } | null }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: unknown } } | null };
...
export type ChatConversationsQueryVariables = Exact<{
  ...
  pOffset?: number | null | undefined;
}>;


export type ChatConversationsQuery = { __typename: 'Query', listChatConversations: { __typename: 'ListChatConversationsConnection', nodes: Array<{ __typename: 'ListChatConversationsRecord', conversationId: unknown, conversationKind: ChatContextKind | null, contextTitle: string | null, contextImageUrl: string | null, otherAccountId: unknown, otherAccountDisplayName: string | null, otherAccountAvatarUrl: string | null, lastMessagePreview: string | null, lastActivityAt: unknown, unreadCount: number | null }> } | null };
...
export type ResourceConversationByIdQuery = { __typename: 'Query', resourceConversationById: { __typename: 'ResourceConversation', id: unknown, resourceId: unknown, ownerAccountId: unknown, bidderAccountId: unknown, resourceByResourceId: { __typename: 'Resource', id: unknown, title: string, imageUrls: Array<string | null> } | null, accountByOwnerAccountId: { __typename: 'Account', id: unknown, displayName: string | null, avatarUrl: string | null } | null, accountByBidderAccountId: { __typename: 'Account', id: unknown, displayName: string | null, avatarUrl: string | null } | null } | null };

export type ResourceConversationLookupQueryVariables = Exact<{
  resourceId: unknown;
  ownerAccountId: unknown;
  bidderAccountId: unknown;
}>;


export type ResourceConversationLookupQuery = { __typename: 'Query', resourceConversationByResourceIdAndOwnerAccountIdAndBidderAccountId: { __typename: 'ResourceConversation', id: unknown } | null };
...
export type ResourceMessagesQuery = { __typename: 'Query', allResourceMessages: { __typename: 'ResourceMessagesConnection', nodes: Array<{ __typename: 'ResourceMessage', id: unknown, body: string, createdAt: unknown, senderAccountId: unknown, resourceMessageImagesByMessageId: { __typename: 'ResourceMessageImagesConnection', nodes: Array<{ __typename: 'ResourceMessageImage', imageUrl: string }> } }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: unknown } } | null };
...
export type CreateResourceMessageImageMutationVariables = Exact<{
  input: CreateResourceMessageImageInput;
}>;


export type CreateResourceMessageImageMutation = { __typename: 'Mutation', createResourceMessageImage: { __typename: 'CreateResourceMessageImagePayload', resourceMessageImage: { __typename: 'ResourceMessageImage', id: unknown, imageUrl: string } | null } | null };
...
export type SendResourceMessageDirectMutation = { __typename: 'Mutation', sendResourceMessageDirect: { __typename: 'SendResourceMessageDirectPayload', resourceMessage: { __typename: 'ResourceMessage', id: unknown, conversationId: unknown } | null, resourceConversationByConversationId: { __typename: 'ResourceConversation', id: unknown } | null } | null };
...
export type SubmitResourceBidMutation = { __typename: 'Mutation', submitResourceBid: { __typename: 'SubmitResourceBidPayload', resourceBid: { __typename: 'ResourceBid', id: unknown } | null } | null };
...
export type CancelResourceBidMutation = { __typename: 'Mutation', cancelResourceBid: { __typename: 'CancelResourceBidPayload', resourceBid: { __typename: 'ResourceBid', id: unknown } | null } | null };
...
export type RespondToResourceBidMutation = { __typename: 'Mutation', respondToResourceBid: { __typename: 'RespondToResourceBidPayload', resourceBid: { __typename: 'ResourceBid', id: unknown, status: ResourceBidStatus } | null } | null };
...
export type NeedClaimNotificationsQueryVariables = Exact<{
  first?: number | null | undefined;
}>;


export type NeedClaimNotificationsQuery = { __typename: 'Query', allNeedClaimNotifications: { __typename: 'NeedClaimNotificationsConnection', nodes: Array<{ __typename: 'NeedClaimNotification', id: unknown, needClaimId: unknown, eventType: string, payload: unknown, createdAt: unknown, readAt: unknown }> } | null };

export type ResourceBidNotificationsQueryVariables = Exact<{
  first?: number | null | undefined;
}>;


export type ResourceBidNotificationsQuery = { __typename: 'Query', allResourceBidNotifications: { __typename: 'ResourceBidNotificationsConnection', nodes: Array<{ __typename: 'ResourceBidNotification', id: unknown, resourceBidId: unknown, eventType: string, payload: unknown, createdAt: unknown, readAt: unknown }> } | null };
...
export type MarkNeedClaimNotificationReadMutation = { __typename: 'Mutation', markNeedClaimNotificationRead: { __typename: 'MarkNeedClaimNotificationReadPayload', needClaimNotification: { __typename: 'NeedClaimNotification', id: unknown, readAt: unknown } | null } | null };
...
export type MarkResourceBidNotificationReadMutation = { __typename: 'Mutation', markResourceBidNotificationRead: { __typename: 'MarkResourceBidNotificationReadPayload', resourceBidNotification: { __typename: 'ResourceBidNotification', id: unknown, readAt: unknown } | null } | null };
...
export type AccountProfileQuery = { __typename: 'Query', accountById: { __typename: 'Account', id: unknown, displayName: string | null, avatarUrl: string | null, bio: string | null, location: string | null, latitude: unknown, longitude: unknown, preferredLanguage: string, profileLinks: unknown } | null, allResources: { __typename: 'ResourcesConnection', nodes: Array<{ __typename: 'Resource', id: unknown, title: string, description: string | null, imageUrls: Array<string | null> }> } | null };
...
export type UpdateAccountProfileMutation = { __typename: 'Mutation', updateAccountById: { __typename: 'UpdateAccountPayload', account: { __typename: 'Account', id: unknown, displayName: string | null, avatarUrl: string | null, bio: string | null, location: string | null, latitude: unknown, longitude: unknown, profileLinks: unknown } | null } | null };
...
export const ChatConversationsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ChatConversations"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pLimit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pOffset"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"listChatConversations"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"pLimit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pLimit"}}},{"kind":"Argument","name":{"kind":"Name","value":"pOffset"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pOffset"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"conversationId"}},{"kind":"Field","name":{"kind":"Name","value":"conversationKind"}},{"kind":"Field","name":{"kind":"Name","value":"contextTitle"}},{"kind":"Field","name":{"kind":"Name","value":"contextImageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"otherAccountId"}},{"kind":"Field","name":{"kind":"Name","value":"otherAccountDisplayName"}},{"kind":"Field","name":{"kind":"Name","value":"otherAccountAvatarUrl"}},{"kind":"Field","name":{"kind":"Name","value":"lastMessagePreview"}},{"kind":"Field","name":{"kind":"Name","value":"lastActivityAt"}},{"kind":"Field","name":{"kind":"Name","value":"unreadCount"}}]}}]}}]}}]} as unknown as DocumentNode<ChatConversationsQuery, ChatConversationsQueryVariables>;
...
export const CreateResourceMessageImageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateResourceMessageImage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateResourceMessageImageInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createResourceMessageImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resourceMessageImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}}]}}]}}]}}]} as unknown as DocumentNode<CreateResourceMessageImageMutation, CreateResourceMessageImageMutationVariables>;
export const SendResourceMessageDirectDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SendResourceMessageDirect"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SendResourceMessageDirectInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sendResourceMessageDirect"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resourceMessage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"conversationId"}}]}},{"kind":"Field","name":{"kind":"Name","value":"resourceConversationByConversationId"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<SendResourceMessageDirectMutation, SendResourceMessageDirectMutationVariables>;
