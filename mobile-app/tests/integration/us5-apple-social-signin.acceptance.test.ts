...
describe("US5 Apple social signin acceptance", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it("signs returning users in directly from an Apple success callback", async () => {
    ...
    const callbackUrl = "topela://auth/apple/callback?status=success&provider=apple&next=%2Fmy-hub&sessionToken=returned-session-token";
