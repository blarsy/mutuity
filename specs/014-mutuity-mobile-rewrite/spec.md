...
**Independent Test**: A tester can validate both authenticated parity flows and anonymous browse-only behavior on mobile without needing the new campaign or needs features.
