...
1. Feature 005 resource discovery/publishing: resource discovery and a basic publish success path.
2. Feature 006 chat/conversation handoff: open existing thread and draft creation from a transaction context.
3. Feature 009 listing visual identity: verify no broken image UI and consistent header strip on needs/resources.
4. Feature 003 platform baseline: keep this at backend/integration level unless a user-facing critical path emerges.
