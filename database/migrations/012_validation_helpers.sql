...
grant execute on function app_private.validate_campaign_dates(timestamptz, timestamptz, timestamptz)
  to identified_account, manager, admin;
grant execute on function app_private.validate_topes_amount(text, integer)
  to identified_account, manager, admin;
