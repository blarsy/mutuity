-- Fix admin_list_campaigns description column mapping so admin 'View description'
-- shows the campaign description instead of the creator note for moderator.
...
begin
  ...
  where (
    ...
    or coalesce(c.description,               '') ilike ('%' || v_search || '%')
