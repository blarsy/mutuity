...
begin
  ...
  set status = 'accepted',
      ...
      acted_at = now()
  where campaign_id = accept_campaign_need.campaign_id
    and need_id = accept_campaign_need.need_id
...
begin
  ...
  set status = 'rejected',
      acted_by_account_id = v_account_id,
      acted_at = now()
  where campaign_id = reject_campaign_need.campaign_id
    and need_id = reject_campaign_need.need_id
  returning * into v_campaign_need;
